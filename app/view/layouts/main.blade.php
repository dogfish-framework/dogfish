...
<head>
    ...
    <link href="{{url('css/materialize/fontemeterilize.css')}}" rel="stylesheet" type="text/css">
    <link href="{{url('css/materialize/iconematerialize.css')}}" rel="stylesheet" type="text/css">
...
<script src="{{url('js/app/main.js')}}"></script>
</body>
</html>
